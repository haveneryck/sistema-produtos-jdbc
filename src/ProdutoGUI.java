...
public class ProdutoGUI extends Application {
    ...
    public void start(Stage palco) {
        ...
        addButton.setOnAction(e -> {
            ...
            produtoDAO.inserir(produto); // Insere o novo procuto no banco de dados
            produtos.setAll(produtoDAO.listarTodos()); // Atualiza a lista de produtos na tela
            limparCampos(); // Limpa os campos de entrada para digitação
        });
    ...
    /**
     * O método stop é chamado automaticamente uando a aplicação JavaFX é encerrada.
     */
    @Override
    public void stop() {
        try {
     ...
     * Este método é chamado após adicionar, atualizar o excluir um produto
     * para garantir que os campos de entrada estejam pronto par auma nova entrada.
     */
